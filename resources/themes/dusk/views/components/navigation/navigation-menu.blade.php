<nav class="nav-header">
    <div class="max-w-7xl w-full flex justify-between items-center h-[120px]">
        ...
        <div class="flex text-white gap-x-14">
            ...
            <a href="{{ route('values.index') }}" class="flex flex-col gap-1 items-center transition ease-in-out hover:text-[#ac93da]">
                <img class="icon" src="{{ asset('/assets/images/dusk/rare.png') }}" alt="community icon">
                {{ __('Rare values') }}
            </a>
