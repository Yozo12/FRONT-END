    ...
    <div class="col-span-12 md:col-span-6 min-h-[250px] bg-gray-900/50 rounded-xl flex flex-col py-6 px-8 text-white">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="relative w-full overflow-hidden text-black">
                <input id="username-input" type="text" placeholder="Scrivi il tuo usernamne" name="username" class="relative py-2 rounded-md mt-3 w-full">

                <img id="user-avatar" class="absolute right-0 -top-4" src="{{ asset('/assets/images/dusk/ghost.png') }}" alt="">
            </div>

            <input type="password" placeholder="Scrivi la tua password" name="password" class="relative py-2 rounded-md mt-3 text-black w-full">
            ...
            <div class="mt-4 flex gap-4">
                ...
                <a href="{{ route('register') }}" class="w-full">
                    <button type="button" class="py-2 px-4 text-white bg-gray-700 border-2 border-gray-600 w-full rounded-md transition duration-300 ease-in-out hover:scale-[102%]">Registrati</button>
                </a>
            </div>
        </form>
    </div>
