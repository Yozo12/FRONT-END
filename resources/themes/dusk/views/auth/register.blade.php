        ...
        <form action="{{ route('register') }}" method="POST">
           ...
           <x-site-captchas />
            ...
            <div class="mt-4 grid grid-cols-2 gap-3">
                <button type="submit" class="py-2 px-4 text-white bg-yellow-500 border-2 border-yellow-300 w-full rounded-md transition duration-300 ease-in-out hover:scale-[102%]">Registrati</button>
        ...
        <div class="swiper h-[250px] rounded-md">
            ...
            <div class="swiper-wrapper" style="z-index: 14;">
                @foreach($articles as $article)
                    <div class="swiper-slide relative article-image" style="background-image: url('{{ asset('storage/' . $article->image) }}')">
