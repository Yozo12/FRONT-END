<x-installation-layout>
    <x-content.installation-content-section icon="hotel-icon" classes="border">
        ...
        <div class="space-y-3">
            <p>
                {{ __('Congratulations on successfully completing the Yabbo setup! You have now taken the first steps towards an exciting new journey. With Yabbo, you can effortlessly manage various aspect of your hotel, while giving your new visitors an easy gateway into a world of joy.') }}
            </p>

            <p>
                {{ __('You can at any time change the settings you went through. All it takes is for you to hop into your database and find the "website_settings" table and then tweak the settings you wish. Who knows... As you explore the features and functionalities of Yabbo, you might discover features that will improve you and your users experience & helping you achieve your online goals!') }}
            </p>

            <p>
                {!! __('We also have written a throughout documentation, explaining tons of things regarding managing Yabbo & other aspect of your hotel. You can visit our <a href=":documentation_link" target="_blank" class="font-semibold underline">comprehensive documentation right here</a>. Our goal is to keep expanding our coverage, so keep checking it from time to time.') !!}
            </p>
