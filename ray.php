...
return [
    ...
    * When using Docker on Mac or Windows, you can replace 161.97.134.153 with 'host.docker.internal'
    * When using Homestead with the VirtualBox provider, you can replace 161.97.134.153 with '10.0.2.2'
    * When using Homestead with the Parallels provider, you can replace 161.97.134.153 with '10.211.55.2'
    */
