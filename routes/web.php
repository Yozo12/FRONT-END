...
Route::middleware(['maintenance', 'check.ban', 'force.staff.2fa'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/values/add', [WebsiteRareValuesController::class, 'add'])->name('values.add');
        Route::post('/values/add', [WebsiteRareValuesController::class, 'store'])->name('values.store');
        Route::delete('/values/{id}', [WebsiteRareValuesController::class, 'delete'])->name('values.delete');
